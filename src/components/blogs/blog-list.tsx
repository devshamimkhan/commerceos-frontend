...
function BlogTableSkeleton() {
  return Array.from({ length: 5 }, (_, index) => (
    <tr key={index} className="blog-table-skeleton" aria-hidden="true">
      <td className="px-4 py-4"><span className="blog-skeleton-block blog-skeleton-title" /></td><td className="px-4 py-4"><span className="blog-skeleton-block blog-skeleton-slug" /></td><td className="px-4 py-4"><span className="blog-skeleton-block blog-skeleton-status" /></td><td className="px-4 py-4"><span className="blog-skeleton-block blog-skeleton-date" /></td><td className="px-4 py-4"><span className="blog-skeleton-block blog-skeleton-actions" /></td>
    </tr>
  ));
}
